    ...
    <div class="container py-5">
        ...
        <form action="{{ route('admin.apartments.store') }}" method="POST" enctype="multipart/form-data" class="form-control p-4 mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" aria-describedby="titleHelper" placeholder="Insert the title of your apartment" minlength="5" value="{{ old('title') }}" required>
                ...
                <div class="address-street_number d-flex gap-2">
                    ...
                    <div class="mb-3 w-25">
                        ...
                        <input type="text" class="form-control @error('street_number') is-invalid @enderror" name="street_number" id="street_number" aria-describedby="street_numberHelper" placeholder="5" value="{{ old('street_number') }}">
                ...
                <div class="country-zip-city d-flex gap-2">
                    ...
                    <div class="mb-3 w-50">
                        ...
                        <select class="form-select @error('country_code') is-invalid @enderror" id="country_code" name="country_code">
                            ...
                            @foreach ($nations as $nation)
                                <option value="{{ $nation['code'] }}" {{ old('country_code') == $nation['code'] ? 'selected' : '' }}>{{ $nation['name'] }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3 w-25">
                        ...
                        <input type="text" class="form-control @error('city') is-invalid @enderror" name="city" id="city" aria-describedby="cityHelper" placeholder="Rome" value="{{ old('city') }}" required>
                    ...
                    <div class="mb-3 w-25">
                        ...
                        <input type="text" class="form-control @error('zip_code') is-invalid @enderror" name="zip_code" id="zip_code" aria-describedby="zip_codeHelper" placeholder="00100" value="{{ old('zip_code') }}" minlength="2" maxlength="15" required>
                    ...
                    <div class="d-flex gap-5">
                        <div class="sq_meters w-25">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <input type="number" class="form-control @error('square_meters') is-invalid @enderror" name="square_meters" id="square_meters" aria-describedby="square_metersHelper" placeholder="60" value="{{ old('square_meters') }}" min="1">
                        ...
                        <div class="n_rooms w-25">
                            ...
                            <input type="number" class="form-control @error('rooms') is-invalid @enderror" name="rooms" id="rooms" aria-describedby="roomsHelper" placeholder="1" value="{{ old('rooms') }}" min="1">
                            @error('rooms')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="n_beds w-25">
                            ...
                            <input type="number" class="form-control @error('beds') is-invalid @enderror" name="beds" id="beds" aria-describedby="bedsHelper" placeholder="1" value="{{ old('beds') }}" min="1">
                            @error('beds')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="n_bathrooms w-25">
                            ...
                            <input type="number" class="form-control @error('bathrooms') is-invalid @enderror" name="bathrooms" id="bathrooms" aria-describedby="bathroomsHelper" placeholder="1" value="{{ old('bathrooms') }}" min="1">
                            @error('bathrooms')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <label class="btn btn-outline-primary">
                        <input type="radio" class="me-2" name="visibility" id="visible" autocomplete="off" value="1" {{ old('visibility', 1) == 1 ? 'checked' : '' }} required> Visible
                    </label>
                    <label class="btn btn-outline-primary">
                        <input type="radio" class="me-2" name="visibility" id="not_visible" autocomplete="off" value="0" {{ old('visibility') == 0 ? 'checked' : '' }} required> Not Visible
                    </label>
                </div>
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        @foreach ($services as $service)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="{{ $service->id }}" id="service_{{ $service->id }}" name="services[]" {{ in_array($service->id, old('services', [])) ? 'checked' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" rows="6" placeholder="Add a brief description of your apartment">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
